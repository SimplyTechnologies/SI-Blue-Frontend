  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          'fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear md:flex border-[var(--border-color)]',
          side === 'left'
...
function SidebarHeader({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      data-sidebar="header"
      className={cn('flex justify-between gap-2 py-6 px-2 border-b-1 border-[var(--border-color)]', className)}
      {...props}
    />
  );
}
